...
- EEG classification performance decreases significantly when scaling across subjects as person-to-person EEG responses to stimuli vary heavily and the CSP model does not do well with such varaible patterns 
- So naturally Inter-subject variability is a major limiting factor in generalisation  
